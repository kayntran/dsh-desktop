/**
 * Browser trust gate for every `/hdw/growth/*` route.
 *
 ...
 *
 * What these routes protect: everything the assistant remembers about the user.
 * A malicious page open in the user's browser reaching them could read the whole
 * memory store, or erase it.
 *
