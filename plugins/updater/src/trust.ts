/**
 * Browser trust gate for every `/hdw/update/*` route.
 *
 * Third deliberate copy in this project of upstream's `isTrustedApiRequest`
 ...
 *
 * What the gate protects here: one of these routes tells the shell to quit and
 * install a downloaded package. A page that could reach it could close the app
 * from under the user, mid-turn.
 *
